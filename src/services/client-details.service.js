...
const getClientDetailsData = async (clientId) => {
  ...
  return {
    ...
    profile: {
      ...
      aadhaarBackDocumentVerified: profile.aadhaarBackDocumentVerified || false,
...
const getClientDocumentsData = async (clientId) => {
  ...
  const docTypes = [
    ...
    {
      name: isInternational ? 'Passport / National ID (Front Side)' : 'Aadhaar Card (Front Side) Upload',
      key: 'aadhaarDocument',
